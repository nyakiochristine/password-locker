            ...
            if selector =="register":
                ...
                while logged_in:
                    ...
                    if select_word == "new":
                         ...
                         u_name = input("Enter your username here")
                         choose = input("Would you like an autogenerated password(yes/no)\n").lower()
                         ...
                         if choose == "yes":
                             ...
                             make_credentials(account_name,u_name,password)
                             
                             
                             
                    elif select_word == "save":
                        print("\033c")
                    ...
                    if logged_in and Credential.cred_list:
                        print("\033c")
                        print("Here is the list of credential details for your accounts")
                        print("\n")
